<h2> 734 46
3043. Find the Length of the Longest Common Prefix</h2><hr><div><p>You are given two arrays with <strong>positive</strong> integers <code>arr1</code> and <code>arr2</code>.</p>
