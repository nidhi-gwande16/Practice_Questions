<h2> 1286 78
2285. Maximum Total Importance of Roads</h2><hr><div><p>You are given an integer <code>n</code> denoting the number of cities in a country. The cities are numbered from <code>0</code> to <code>n - 1</code>.</p>
