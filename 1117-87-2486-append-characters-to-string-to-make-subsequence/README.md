<h2> 1117 87
2486. Append Characters to String to Make Subsequence</h2><hr><div><p>You are given two strings <code>s</code> and <code>t</code> consisting of only lowercase English letters.</p>
