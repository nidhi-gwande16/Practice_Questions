<h2> 2493 153
1497. Check If Array Pairs Are Divisible by k</h2><hr><div><p>Given an array of integers <code>arr</code> of even length <code>n</code> and an integer <code>k</code>.</p>
